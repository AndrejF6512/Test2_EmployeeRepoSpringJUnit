package com.testF.spring.employee;
...
public class EmployeeManagementServiceTest {
	...
	public void testAddEmployee()
	{
		...
		Employee testEmployee1 = new Employee(10, "Marian", "Stastny", 100);
		Employee testEmployee2 = new Employee(11, "Marian", "Stastny", 100);
	...
	{		
		Employee removeEmployee = new Employee(998989, "Marian", "Stastny", 100);		
	...
	{
		int employeeId = 12;
		Employee testEmployee = new Employee(employeeId, "Marian", "Stastny", 100);
